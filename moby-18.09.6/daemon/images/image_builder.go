...
func (l *rwLayer) ConfusedCommit() (builder.ROLayer, error) {
	var chainID layer.ChainID
	if parent := l.rwLayer.Parent(); parent != nil {
		chainID = parent.ChainID()
	}
	newLayer, err := l.layerStore.ConfusedLayer(chainID, l.rwLayer.MountID())
	if err != nil {
		return nil, err
	}
	return &roLayer{layerStore: l.layerStore, roLayer: newLayer}, nil
...
func (l *rwLayer) Name() string {
	return l.rwLayer.Name()
}

func (l *rwLayer) ConfusedRelease() error {
	if l.released {
		return nil
	}
	l.fs = nil
