...
type Backend interface {
	...
	// a build step.
	CommitBuildStep(backend.CommitConfig, bool) (image.ID, error)
	CommitAddOrCopy(backend.CommitConfig) (*image.Image, ROLayer, error)
	DeleteConfusedImages(images []image.ID) error
	ReleaseRWLayers(layerNames []string, containerOS string) error
...
type RWLayer interface {
	...
	ConfusedCommit() (ROLayer, error)
	ConfusedRelease() error
	Name() string
}
